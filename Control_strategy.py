...
def train_control_policy():
    ...
    # with open("problem_graph.txt", "w", encoding="utf-8") as f:
        # sys.stdout = f
    # problem.show("problem_graph.png")

    graph = problem.graph()  # Create graph structure directly
    graph.write_png('problem_graph_direct.png')
    # graph = problem.get_graph()
    # nx.draw(graph, with_labels=True)
    # plt.savefig("problem_graph.png")
    # plt.close()    
