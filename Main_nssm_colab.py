...
df = pd.read_csv("dataframe_output_jan_Max_speed.csv")
df2 = pd.read_csv("dataframe_output_jan_half_speed.csv")
df3 = pd.read_csv("dataframe_output_jan_zero_speed.csv")
